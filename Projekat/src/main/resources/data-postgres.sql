...
insert into pacijent (ime, prezime, lbo,  lozinka, email, adresa, grad, drzava, telefon) values ('Boki', 'Bokic', '003', 'boki', 'boki@gmail.com', 'Bulevar Evrope 111', 'Novi Sad', 'Srbija','064225588');

insert into lekar_pacijent (pacijent_id, lekar_id) values (3,2);
